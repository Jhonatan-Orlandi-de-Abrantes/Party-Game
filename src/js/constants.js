...
export const AUTO_PASS_PREFIX = 'bombPartyAutoPass_';
...
export const ROOM_STATUS = { waiting: 'Aguardando jogadores', playing: 'Em jogo' };
...
export const controlSets = [
  { left: 'a', right: 'd', jump: 'w', pass: 'q', dash: 'shift' },
  { left: 'a', right: 'd', jump: 'w', pass: 'q', dash: 'shift' },
  { left: 'a', right: 'd', jump: 'w', pass: 'q', dash: 'shift' },
  { left: 'a', right: 'd', jump: 'w', pass: 'q', dash: 'shift' }
];
